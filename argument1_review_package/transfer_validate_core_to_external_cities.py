...
CORE = ROOT / "unified_three_city_analysis" / "outputs" / "cross_city" / "city_bias_metrics.csv"
EXT_DIR = ROOT / "external_validation_ntl_predictions_three_cities"
SYDNEY = EXT_DIR / "fine_scale_validation" / "sydney_ausgrid_fine_scale_bias.csv"
MARSEILLE = EXT_DIR / "fine_scale_validation" / "marseille_fine_scale_bias.csv"
OUT = ROOT / "external_transfer_validation_core_to_new_cities"
